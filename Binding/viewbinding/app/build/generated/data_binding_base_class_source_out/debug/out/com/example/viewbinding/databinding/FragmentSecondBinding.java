...
public final class FragmentSecondBinding implements ViewBinding {
  ...
  private FragmentSecondBinding(@NonNull FrameLayout rootView, @NonNull TextView fragmentText) {
  ...
  public static FragmentSecondBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_second_, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static FragmentSecondBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.fragmentText;
      TextView fragmentText = ViewBindings.findChildViewById(rootView, id);
      if (fragmentText == null) {
        break missingId;
      }

      return new FragmentSecondBinding((FrameLayout) rootView, fragmentText);
    }
