...
public final class ActivityViewBindingBinding implements ViewBinding {
  ...
  private ActivityViewBindingBinding(@NonNull ConstraintLayout rootView, @NonNull RecyclerView rv) {
  ...
  public static ActivityViewBindingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityViewBindingBinding((ConstraintLayout) rootView, rv);
    }
